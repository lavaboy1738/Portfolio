...
export const ProjectData: ProjectDataType[] = [
    ...
    },
    {
        ...
        sequence: 4,
        title: "Agency",
        text: ["I had to do it. I just had to build a digital agency website. Prior to transitioning into web development and enrolling in graduate school, I was trained in communications and previously worked in advertising agencies of various scales. From the smaller, modest creative agencies to 4A agencies, they all share something in common, that is, a stunning website with smooth animations and creative interactions. ", "This project was built as I was learning framer motions. I came across this motion library and I was immediately hooked by its functionalities and capabilities. It was a great venture to hone my react skills and create cool transitions. Link to the live version is listed above."],
